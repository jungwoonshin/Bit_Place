...
function loadRepositoryList() {
 ...
 success: function(repositories) {
  ...
  for (var i in repositories) {
            ...
            .append($("<tr>").text(repositories[i].git_id+" " +repositories[i].git_repository)))
            .append($("<tr>").text(repositories[i].content_title)))
            .append($("<tr>").text(repositories[i].content)))
            .appendTo(table);
      }
	}
   });
